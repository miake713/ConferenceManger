...
public class BookPageFactory {
	...
	public static Bitmap m_book_bg = null;
	private int mWidth;
	private int mHeight;
	...
	public BookPageFactory(int w, int h) {
		...
		Paint bPaint12 = new Paint(Paint.ANTI_ALIAS_FLAG);
		bPaint12.setTextAlign(Align.RIGHT);
		bPaint12.setTextSize(b_FontSize);
		bPaint12.setColor(m_textColor);
