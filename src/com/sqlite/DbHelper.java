...
public class DbHelper extends SQLiteOpenHelper {
	...
	public final static String FIELD_ISSUERID = "issueId";
	//字间距
	...
	public BookInfo getBookInfo(int id){
		...
		SQLiteDatabase db = this.getReadableDatabase();
		Cursor cursor = null;
		cursor = db.query(TABLE_NAME, null, "issueId=" + id, null, null, null, null);
	...
	public long insert(String filename, String bookmark,String issueId) {
		SQLiteDatabase db = this.getWritableDatabase();
		ContentValues cv = new ContentValues();
		cv.put(FIELD_FILENAME, filename);
		cv.put(FIELD_BOOKMARK, bookmark);
		cv.put(FIELD_ISSUERID, issueId);
		long row = db.insert(TABLE_NAME, null, cv);
		return row;
	}
