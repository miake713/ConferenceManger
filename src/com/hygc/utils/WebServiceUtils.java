...
public class WebServiceUtils {
	public static final String WEB_SERVER_URL = "http://"+ConferenceActivity.IP_Port+"/hygc/ws/";
	// 含有3个线程的线程池
	...
	public static void callWebService(String url, final String methodName,
	  ...
	  // SoapObject添加参数
    	...
    	/*soapObject.addProperty("state","3");
		soapObject.addProperty("issueId","3");
		soapObject.addProperty("conferenceId","3");*/
		...
		executorService.submit(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					System.out.println("_______________________>"+resultSoapObject);
